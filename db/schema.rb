...
ActiveRecord::Schema.define(version: 2021_02_04_055409) do
  ...
  create_table "purchases_histories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchaser_id"], name: "index_purchases_histories_on_purchaser_id"
  end
  ...
  add_foreign_key "purchases_histories", "purchasers"
end
