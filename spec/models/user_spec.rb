...
RSpec.describe User, type: :model do
  ...
  describe "ユーザー新規登録" do
    context '新規登録できるとき' do
      it "nicknameとemail、passwordとpassword_confirmation、first_nameとlast_name、first_name_katakanaとlast_name_katakana、date_of_birthが存在すれば登録できる" do
    ...
    context '新規登録できないとき' do
      ...
      it "passwordとpassword_confirmationが6文字以上でなければ登録できない" do
        @user.password = "aaa11"
        @user.valid?
      ...
      it "first_name_katakanaがカタカナでないと登録できない" do
        @user.first_name_katakana = "太郎たろう"
        @user.valid?
